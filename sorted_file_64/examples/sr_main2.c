...
int main() {
 ...
 /* printf("Sorting 'unsorted_data.db' file in field 'id' ...\n");		//δικος μας κωδικας
  CALL_OR_DIE(SR_SortedFile("unsorted_data.db", "sorted_id.db", 0, 9))
  printf("Sorting 'unsorted_data.db' file in field 'surname' ...");
  CALL_OR_DIE(SR_SortedFile("unsorted_data.db", "sorted_surname.db", 2, 9))
  ...
  CALL_OR_DIE(SR_SortedFile("sorted_name.db", "sorted_id.db", 0, 3))*/
